...
enum Category: String, CaseIterable {
    ...
    var color: Color {
        ...
        case .education: return Color(#colorLiteral(red: 0.01680417731, green: 0.1983509958, blue: 1, alpha: 1))
        ...
        case .shopping: return Color(#colorLiteral(red: 0.9529411793, green: 0.6862745285, blue: 0.1333333403, alpha: 1))
